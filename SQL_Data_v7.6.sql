...
CREATE TABLE EXAM_PAPER (
    ...
    CONSTRAINT fk_subject_ FOREIGN KEY(SUBJECT_ID) REFERENCES SUBJECT(SUBJECT_ID)
);
...
CREATE TABLE QUESTION (
    ...
    CONSTRAINT part_of FOREIGN KEY (EXAM_ID) REFERENCES EXAM (EXAM_ID)
);
...
-- CREATE TABLE STUDENT_SUBJECT_OVERALL_GRADE (
--     STUDENT_ID VARCHAR(9) NOT NULL, 
...
--ADD DATA TO STUDENT_SUBJECT_OVERALL_GRADE--
INSERT INTO STUDENT_SUBJECT_OVERALL_GRADE VALUES('17616265d', 'PHYSICS_A', '');
INSERT INTO STUDENT_SUBJECT_OVERALL_GRADE VALUES('17354345d', 'PHYSICS_B', '');
INSERT INTO STUDENT_SUBJECT_OVERALL_GRADE VALUES('17512512d', 'ENGLISH_C', '');
